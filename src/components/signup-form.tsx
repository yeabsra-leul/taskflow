...
export function SignupForm({
  ...
  async function handleSignUpUser(e: FormEvent<HTMLFormElement>) {
    ...
    // validate confirm password before attempting signup
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={handleSignUpUser}>
            <FieldGroup>
              ...
              <Field>
                <Button type="submit" className="cursor-pointer">
                  {isSigningUp && <Loader2 className="animate-spin" />} Create
                  Account
                </Button>
              </Field>
